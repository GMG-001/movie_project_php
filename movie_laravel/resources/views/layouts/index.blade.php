            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                <div class="mt-8">
                    <a href="{{route('movie.clicked', $movie->id)}}">
                        <img src="/img/movies/{{$movie->image}}" alt="parasite" class="">
                    </a>
                    <div class="mt-2">
...
{{--                                    </a>--}}
{{--                                </div>--}}
{{--                                <div class="ml-43 text-lg leading-7 font-semibold">--}}
{{--                                    <a href="{{route('movie.clicked', $movie->id)}}" class="underline text-gray-900 dark:text-white">--}}
